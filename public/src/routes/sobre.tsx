  ...
  head: () => ({
    meta: [
      { title: "Sobre Felipe Vasconcelos | Corretor de Imóveis" },
      {
        name: "description",
        content:
          "Conheça Felipe Vasconcelos: corretor de imóveis em Santarém-PA, com foco em atendimento personalizado e transparência.",
      },
    ],
  }),
  component: SobrePage,
    ...
    <SiteLayout>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-2">
          ...
          <div className="text-white">
            ...
            <p className="mt-6 text-[15px] leading-[1.8] text-white/70">
              Sou Felipe Vasconcelos, corretor de imóveis em {SITE.region}. Acredito que cada imóvel
              carrega uma história — e meu trabalho é unir a sua história ao espaço certo para você
              viver, investir ou começar de novo.
            </p>
            <p className="mt-4 text-[15px] leading-[1.8] text-white/70">
              Com anos de mercado na região, conheço os bairros, os preços, os caminhos da
              documentação e os detalhes que fazem diferença na hora de comprar, vender ou alugar.
              Minha proposta é simples: transparência, agilidade e atendimento personalizado de
              ponta a ponta.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="premium-cta inline-flex items-center gap-2 bg-gold px-7 py-3.5 text-[13px] uppercase tracking-[0.08em] text-navy hover:bg-gold-light"
              >
                <MessageCircle className="h-4 w-4" /> Falar comigo
              </a>
              <Link
                to="/imoveis"
                className="premium-cta inline-flex items-center gap-2 border border-white/30 px-7 py-3.5 text-[13px] uppercase tracking-[0.08em] text-white hover:border-gold hover:text-gold"
              >
      ...
      <section className="bg-off-white px-6 py-24 md:px-12">
        <div className="mx-auto max-w-5xl text-center">
          <SectionHeader
            tag="Missão"
            title="Conectar pessoas ao"
            titleEm="imóvel ideal"
            align="center"
            ...
            {[
              {
                icon: Heart,
                title: "Empatia",
                text: "Comprar ou alugar é uma decisão grande. Estou aqui para ouvir antes de oferecer.",
              },
              {
                icon: Target,
                title: "Foco",
                text: "Apresento apenas imóveis alinhados ao que você realmente precisa.",
              },
              {
                icon: Compass,
                title: "Direção",
                text: "Te guio pela documentação, financiamento e burocracia sem sustos.",
              },
              {
                icon: Sparkles,
                title: "Excelência",
                text: "Atendimento premium, comunicação clara e acompanhamento até o pós-venda.",
              },
            ].map((d) => (
              <div
                key={d.title}
      ...
      <section className="bg-gradient-navy px-6 py-20 text-center md:px-12">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="premium-cta mt-8 inline-flex items-center gap-3 bg-whatsapp px-9 py-4 text-[13px] uppercase tracking-[0.08em] text-white hover:bg-[oklch(0.6_0.18_145)]"
        >
